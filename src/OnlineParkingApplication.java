...
class OnlineParkingApplication {
    public static void main(String[] args) {
        ...
        do {
            if (!loggedIn) {
                System.out.println(ANSI_BLUE + ANSI_BOLD + "!! Welcome to Online Parking Application !!" + ANSI_RESET);
                System.out.println();
                ...
                switch (choice) {
                    case 1:
                        ...
                        if (parkingSystem.isUserRegistered(username)) {
                            ...
                            System.out.println();
                            System.out.println(ANSI_BLUE + "User Registration Successful. Welcome!"+ ANSI_RESET);
                            loggedIn = true;
                        }
                        break;
                    case 2:
                ...
                System.out.println("2. Search for available parking spot");
                ...
                switch (choice) {
                    ...
                    case 2:
                        // Booking spot
                        System.out.println();
                        System.out.println("Search for Available Spots :");
                        ...
                        if (spotToBook != null) {
                            ...
                            if (booking != null) {
                                ...
                                System.out.println(ANSI_YELLOW + "Spot Founded , Reservation confirmed. Your Booking ID is: " + booking.getBookingId() + ANSI_RESET);
                            } else {
                    ...
                    case 4:
                        // Logout
                        System.out.println(ANSI_BLUE + "You have been successfully logged out. Thank You , Visit Again!!!" + ANSI_RESET);
                        loggedIn = false;
                        break;
                    default:
